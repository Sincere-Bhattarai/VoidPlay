...
-keepclassmembers class com.voidcorp.voidplay.data.model.** { *; }
-keepclassmembers class com.voidcorp.voidplay.domain.model.** { *; }

-keepattributes Signature, InnerClasses, EnclosingMethod, AnnotationDefault, *Annotation*

# Cast framework classes loaded via manifest/reflective entry points.
-keep class com.voidcorp.voidplay.data.service.cast.CastOptionsProvider { *; }
...
-keep class com.voidcorp.voidplay.data.preferences.PreferenceBackupEntry { *; }
-keep class com.voidcorp.voidplay.data.backup.model.** { *; }
-keep class com.voidcorp.voidplay.data.backup.module.** { *; }
...
-keep class com.voidcorp.voidplay.data.telegram.TelegramStreamProxy { *; }

-keep class com.voidcorp.voidplay.data.telegram.** { *; }
-keep interface com.voidcorp.voidplay.data.telegram.** { *; }
