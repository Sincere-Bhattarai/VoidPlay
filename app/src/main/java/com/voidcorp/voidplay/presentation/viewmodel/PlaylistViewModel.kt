...
import com.voidcorp.voidplay.data.model.Playlist
import com.voidcorp.voidplay.data.model.Song
import com.voidcorp.voidplay.data.model.SortOption
import com.voidcorp.voidplay.data.playlist.M3uManager
...
class PlaylistViewModel @Inject constructor(
    ...
    private val aiPlaylistGenerator: com.voidcorp.voidplay.data.ai.AiPlaylistGenerator,
    ...
    private fun findFolder(
        targetPath: String,
        folders: List<com.voidcorp.voidplay.data.model.MusicFolder>
    ): com.voidcorp.voidplay.data.model.MusicFolder? {
        val queue: ArrayDeque<com.voidcorp.voidplay.data.model.MusicFolder> = ArrayDeque(folders)
    ...
    private fun com.voidcorp.voidplay.data.model.MusicFolder.collectAllSongs(): List<Song> {
    ...
    fun exportPlaylistsAsM3u(playlistIds: List<String>) {
        ...
        viewModelScope.launch {
            try {
                ...
                val exportDir = File(musicDir, "VoidPlay Exports")
                if (!exportDir.exists()) {
                    exportDir.mkdirs()
                }
                ...
                Toast.makeText(context, "Exported ${playlistsWithSongs.size} playlist(s) to Music/VoidPlay Exports", Toast.LENGTH_SHORT).show()
