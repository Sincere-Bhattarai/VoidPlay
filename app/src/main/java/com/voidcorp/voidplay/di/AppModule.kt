package com.voidcorp.voidplay.di
...
import com.voidcorp.voidplay.BuildConfig
import com.voidcorp.voidplay.VoidPlayApplication
import com.voidcorp.voidplay.data.database.AlbumArtThemeDao
import com.voidcorp.voidplay.data.database.EngagementDao
import com.voidcorp.voidplay.data.database.FavoritesDao
import com.voidcorp.voidplay.data.database.GDriveDao
import com.voidcorp.voidplay.data.database.LyricsDao
import com.voidcorp.voidplay.data.database.MusicDao
import com.voidcorp.voidplay.data.database.VoidPlayDatabase
...
import com.voidcorp.voidplay.data.preferences.dataStore
import com.voidcorp.voidplay.data.media.SongMetadataEditor
import com.voidcorp.voidplay.data.network.deezer.DeezerApiService
import com.voidcorp.voidplay.data.network.netease.NeteaseApiService
import com.voidcorp.voidplay.data.network.lyrics.LrcLibApiService
import com.voidcorp.voidplay.data.repository.ArtistImageRepository
import com.voidcorp.voidplay.data.repository.LyricsRepository
import com.voidcorp.voidplay.data.repository.LyricsRepositoryImpl
import com.voidcorp.voidplay.data.repository.MediaStoreSongRepository
import com.voidcorp.voidplay.data.repository.MusicRepository
import com.voidcorp.voidplay.data.repository.MusicRepositoryImpl
import com.voidcorp.voidplay.data.repository.SongRepository
import com.voidcorp.voidplay.data.repository.TransitionRepository
import com.voidcorp.voidplay.data.repository.TransitionRepositoryImpl
import com.voidcorp.voidplay.data.repository.FolderTreeBuilder
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.voidcorp.voidplay.data.service.MusicService::class.java)
        )
    }
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.voidcorp.voidplay.data.observer.MediaStoreObserver,
    ...
    @Singleton
    @Provides
    fun provideTelegramDao(database: VoidPlayDatabase): com.voidcorp.voidplay.data.database.TelegramDao {
        return database.telegramDao()
    }

    @Singleton
    @Provides
    fun provideNeteaseDao(database: VoidPlayDatabase): com.voidcorp.voidplay.data.database.NeteaseDao {
    ...
    fun provideMusicRepository(
        ...
        telegramDao: com.voidcorp.voidplay.data.database.TelegramDao,
        telegramCacheManager: com.voidcorp.voidplay.data.telegram.TelegramCacheManager,
        telegramRepository: com.voidcorp.voidplay.data.telegram.TelegramRepository,
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                val requestWithUserAgent = originalRequest.newBuilder()
                    .header("User-Agent", "VoidPlay/1.0 (Android; Music Player)")
                    .build()
